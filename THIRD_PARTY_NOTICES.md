...
| File | Nature |
|------|--------|
| `src/test/resources/matsim-spec/transitSchedule-current-v2.xml` | Hand-written from the transitSchedule v2 DTD content model; used as a test oracle. No MATSim or external-converter code. |
| `src/test/resources/matsim-spec/vehicleDefinitions-current-v2.xml` | Hand-written from the vehicleDefinitions v2.0 schema; used as a test oracle. No MATSim or external-converter code. |
